                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-10 col-lg-11">
                        <select class="form-control" id="mapel" name="mapel">
                            <option selected value="{{ $mapel->id }}" text="{{ $mapel->kode }} - {{ $mapel->kelas->nama }} - {{ $mapel->nama }} - {{ $mapel->dosen->firstName }} {{ $mapel->dosen->lastName }}">{{ $mapel->kode }} - {{ $mapel->kelas->nama }} - {{ $mapel->nama }} - {{ $mapel->dosen->firstName }} {{ $mapel->dosen->lastName }}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row mb-4">
