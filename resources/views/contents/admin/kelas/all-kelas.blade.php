...
<div class="card-box mb-30">
    <div class="pd-20 d-flex justify-content-between">
        ...
        <div>
            <a class="btn btn-primary" href="{{route('admin.kelas.showadd')}}">Tambah Data Kelas</a>
        </div>
    </div>
    <div class="pb-20">
                    ...
                    <td class="text-center">
                        <div class="dropleft">
                            ...
                            <div class="dropdown-menu">
                                <!-- Dropdown menu links -->
                                <a class="dropdown-item" href="{{route('admin.kelas.showedit', ['kelas'=>$kelas->id])}}">Edit</a>
                                <form action="{{route('admin.kelas.delete', ['kelas'=>$kelas->id])}}" method="post">
                                    @method('delete')
                                    @csrf
