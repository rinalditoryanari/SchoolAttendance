...
<div class="card-box mb-30">
    <div class="pd-20 d-flex justify-content-between">
        ...
        <div>
            <a class="btn btn-primary" href="{{ route('admin.mapel.add') }}">Tambah Data Mapel</a>
        </div>
    </div>
    <div class="pb-20">
        <table class="table stripe hover data-table-export nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Bpk/Ibu {{ $mapel->dosen->firstName }} {{ $mapel->dosen->lastName }}</td>
                    <td class="text-center">
                        <div class="dropleft">
                            ...
                            <div class="dropdown-menu">
                                <!-- Dropdown menu links -->
                                <a class="dropdown-item" href="{{ route('admin.mapel.showedit', ['mapel' => $mapel->id]) }}">Edit</a>
                                <form action="{{ route('admin.mapel.delete', ['mapel' => $mapel->id]) }}" method="post">
                                    @method('delete')
                                    @csrf
