...
<div class="pd-20 card-box mb-30">
    ...
    <form method="POST" action="{{route('admin.mahasiswa.add')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group @error('tmpLahir') has-danger @enderror">
                    ...
                    <input value="{{ old('tmpLahir') }}" name="tmpLahir" id="tmpLahir" type="text" class="form-control @error('tmpLahir') form-control-danger @enderror">
                    @error('tmpLahir')
                    <div class="form-control-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group @error('tglLahir') has-danger @enderror">
                    ...
                    <input value="{{ old('tglLahir') }}" name="tglLahir" id="tglLahir" class="form-control" placeholder="Pilih Tanggal Lahir" type="date">
                    @error('tglLahir')
                    <div class="form-control-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group @error('jnsKelamin') has-danger @enderror">
                    ...
                    <select name="jnsKelamin" id="jnsKelamin" class="selectpicker form-control" data-style="btn-outline-primary">
                        ...
                        <option {{ old('jnsKelamin') == 'Laki-laki' ? 'selected' : '' }} value="Laki-laki">Laki-laki</option>
                        <option {{ old('jnsKelamin') == 'Perempuan' ? 'selected' : '' }} value="Perempuan">Perempuan</option>
                    </select>
                    @error('jnsKelamin')
                    <div class="form-control-feedback">{{ $message }}</div>
                    @enderror
