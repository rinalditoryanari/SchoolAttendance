...
<div class="card-box mb-30">
    <div class="pd-20 d-flex justify-content-between">
        ...
        <div>
            <a class="btn btn-primary" href="{{route('admin.absensi.showadd')}}">Tambah Data Keterangan Presensi</a>
        </div>
    </div>
    <div class="pb-20">
                    ...
                    <td class="text-center">
                        <div class="dropleft">
                            ...
                            <div class="dropdown-menu">
                                <!-- Dropdown menu links -->
                                <a class="dropdown-item" href="{{route('admin.absensi.showedit', ['absensi'=>$absensi->id])}}">Edit</a>
                                <form action="{{route('admin.absensi.delete', ['absensi'=>$absensi->id])}}" method="post">
                                    @method('delete')
                                    @csrf
