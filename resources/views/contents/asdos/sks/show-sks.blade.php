...
<div class="card-box mb-30">
    ...
    <div class="pb-2">
        <form class="mx-4" action="{{route('asdos.sks.show')}}" method="get">
            @csrf
            <div class="">
                @error('mapel')
        ...
        <table class="data-table table stripe hover nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="table-plus">{{ ($pertemuan->presensi)? $pertemuan->presensi->nama : "-" }} {{($pertemuan->presensi AND $pertemuan->presensi->level === "dosen") ? "(Dosen)" : ""}}</td>
