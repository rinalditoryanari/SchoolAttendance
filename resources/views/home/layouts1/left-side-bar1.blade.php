    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                ...
                <li>
                    <a href="/siswa/presensi" class="dropdown-toggle no-arrow {{ Request::is('/presensi') ? 'active' : '' }}">
            ...
            {{-- <li>
                ...
                <li>
                    <a href="#" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-book1"></span><span class="mtext">Mapel</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-open-book"></span><span class="mtext">Mapel Guru</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-school"></span><span class="mtext">Kelas</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-user3"></span><span class="mtext">Siswa</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="dropdown-toggle no-arrow">
                        <span class="micon dw dw-user-2"></span><span class="mtext">Kelas Siswa</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="dropdown-toggle no-arrow">
