        ...
        <table>
            <thead>
                ...
                <tr>
                    ...
                    <th class="text-left" colspan="{{round((4 + $pertemuans->count() +$absensis->count())/3)}}">Wali Kelas: {{$mapel->user->firstName}} {{$mapel->user->lastName}}</th>
                </tr>
                <tr>
                    <th class="text-left" colspan="{{round((4 + $pertemuans->count() +$absensis->count())/3)}}">Jumlah Siswa: {{$jumlah['siswa']}}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{$siswa['rekap'][$absensi->kode]}}</td>
                    @else
