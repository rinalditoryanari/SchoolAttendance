    ...
    <div class="my-class">
        <table>
            <thead>
                ...
                <tr>
                    <th class="text-left" colspan="{{round((4 + $pertemuans->count() +$absensis->count())/3)}}">Nama: {{$guru->firstName}} {{$guru->lastName}}</th>
                    <th class="text-left" colspan="{{(4 + $pertemuans->count() +$absensis->count()) - 2*round((4 + $pertemuans->count() +$absensis->count())/3)}}">Email: {{$guru->email}}</th>
                    <th class="text-left" colspan="{{round((4 + $pertemuans->count() +$absensis->count())/3)}}">No. Telefon: {{$guru->phone}}</th>
                </tr>
                <tr>
                    <th rowspan='2'>No</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{$mapel['rekap'][$absensi->kode]}}</td>
                    @else
