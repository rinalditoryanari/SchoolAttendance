    ...
    <div class="pd-20 d-flex justify-content-between">
        ...
        <div class="dropleft">
            ...
            <div class="dropdown-menu">
                <!-- Dropdown menu links -->
                <a class="dropdown-item" href="/admin/siswa/create">Tambah</a>
                <a class="dropdown-item" href="/admin/siswa/{{ $siswa->id }}/edit">Edit</a>
            ...
            <a class="btn btn-outline-primary" href="/admin/siswa"><i class="bi bi-arrow-return-left"></i></a>
        </div>
    </div>
    <div class="pb-20">
