...
<div class="card-box mb-30">
    <div class="pd-20 d-flex justify-content-between">
        ...
        <div>
            <a class="btn btn-primary" href="/admin/keteranganPresensi/create">Tambah Data Keterangan Presensi</a>
        </div>
    </div>
    <div class="pb-20">
                    ...
                    <td class="text-center">
                        <div class="dropleft">
                            ...
                            <div class="dropdown-menu">
                                <!-- Dropdown menu links -->
                                <a class="dropdown-item" href="/admin/keteranganPresensi/{{ $absensi->id }}/edit">Edit</a>
                                <form action="/admin/keteranganPresensi/{{ $absensi->id }}" method="post">
                                    @method('delete')
                                    @csrf
